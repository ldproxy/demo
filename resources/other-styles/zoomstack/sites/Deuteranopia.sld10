    ...
    <UserStyle>
        ...
        <FeatureTypeStyle>
            ...
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#ecdafe</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#f7fbaf</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#f7e937</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#d2d7d0</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
        </FeatureTypeStyle>
