...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
        <Title>OS Open Zoomstack Tritanopia style</Title>
        ...
        <FeatureTypeStyle>
            ...
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#f7ddb0</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#ff9bbb</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#f6ba82</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
            <Rule>
                ...
                <PolygonSymbolizer>
                    <Fill>
                    <CssParameter name="fill">#e2ecf6</CssParameter>
                    </Fill>
                </PolygonSymbolizer>
            </Rule>
        </FeatureTypeStyle>
