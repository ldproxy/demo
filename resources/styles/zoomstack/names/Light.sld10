      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Halo>
              <Radius>1.5</Radius>
              <Fill>
                <CssParameter name="fill">#f1efec</CssParameter>
              </Fill>
            </Halo>
            <Fill>
              <CssParameter name="fill">#55595c</CssParameter>
            </Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#89a489</CssParameter>
            </Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#6c8499</CssParameter>
            </Fill>
