      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Halo>
              <Radius>1.5</Radius>
              <Fill>
                <CssParameter name="fill">#162639</CssParameter>
              </Fill>
            </Halo>
            <Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#396132</CssParameter>
            </Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Halo>
              <Radius>3</Radius>
              <Fill>
                <CssParameter name="fill">#3c5472</CssParameter>
              </Fill>
            </Halo>
            <Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#7e93a2</CssParameter>
            </Fill>
        ...
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#376586</CssParameter>
            </Fill>
